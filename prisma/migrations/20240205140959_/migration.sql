...
-- CreateIndex
CREATE UNIQUE INDEX "electoralarea_un" ON "ElectoralArea"("name", "districtId");
...
-- CreateIndex
CREATE UNIQUE INDEX "PremisesType_inspectionFormId_name_key" ON "PremisesType"("inspectionFormId", "name");

-- CreateIndex
CREATE UNIQUE INDEX "PremisesSubtype_premisesTypeId_name_key" ON "PremisesSubtype"("premisesTypeId", "name");
...
-- AddForeignKey
ALTER TABLE "EateryPremisesInfoSection" ADD CONSTRAINT "EateryPremisesInfoSection_eateryPremisesSubTypeId_fkey" FOREIGN KEY ("eateryPremisesSubTypeId") REFERENCES "PremisesSubtype"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "EateryPremisesInfoSection" ADD CONSTRAINT "EateryPremisesInfoSection_eateryPremisesTypeId_fkey" FOREIGN KEY ("eateryPremisesTypeId") REFERENCES "PremisesType"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "HealthPremisesInfoSection" ADD CONSTRAINT "HealthPremisesInfoSection_healthPremisesTypeId_fkey" FOREIGN KEY ("healthPremisesTypeId") REFERENCES "PremisesType"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "HospitalityPremisesInfoSection" ADD CONSTRAINT "HospitalityPremisesInfoSection_hospitalityPremisesTypeId_fkey" FOREIGN KEY ("hospitalityPremisesTypeId") REFERENCES "PremisesType"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "SanitaryPremisesInfoSection" ADD CONSTRAINT "SanitaryPremisesInfoSection_sanitaryPremisesTypeId_fkey" FOREIGN KEY ("sanitaryPremisesTypeId") REFERENCES "PremisesType"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "MarketPremisesInfoSection" ADD CONSTRAINT "MarketPremisesInfoSection_marketPremisesTypeId_fkey" FOREIGN KEY ("marketPremisesTypeId") REFERENCES "PremisesType"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "InstitutionPremisesInfoSection" ADD CONSTRAINT "InstitutionPremisesInfoSection_institutionPremisesSubtypeI_fkey" FOREIGN KEY ("institutionPremisesSubtypeId") REFERENCES "PremisesSubtype"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "InstitutionPremisesInfoSection" ADD CONSTRAINT "InstitutionPremisesInfoSection_institutionPremisesTypeId_fkey" FOREIGN KEY ("institutionPremisesTypeId") REFERENCES "PremisesType"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "IndustryPremisesInfoSection" ADD CONSTRAINT "IndustryPremisesInfoSection_industryPremisesSubtypeId_fkey" FOREIGN KEY ("industryPremisesSubtypeId") REFERENCES "PremisesSubtype"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "IndustryPremisesInfoSection" ADD CONSTRAINT "IndustryPremisesInfoSection_industryPremisesTypeId_fkey" FOREIGN KEY ("industryPremisesTypeId") REFERENCES "PremisesType"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "PremisesWaterSupply" ADD CONSTRAINT "PremisesWaterSupply_waterSupplyTypeId_fkey" FOREIGN KEY ("waterSupplyId") REFERENCES "WaterSupplyType"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "SanitationReport" ADD CONSTRAINT "SanitationReport_reportCategoryId_fkey" FOREIGN KEY ("reportCategoryId") REFERENCES "ReportCategory"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "SanitationReport" ADD CONSTRAINT "SanitationReport_sanitationReportUserId_fkey" FOREIGN KEY ("sanitationReportUserId") REFERENCES "SanitationReportUser"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "SanitationReport" ADD CONSTRAINT "SanitationReport_regionId_fkey" FOREIGN KEY ("regionId") REFERENCES "Region"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "FollowUpInspection" ADD CONSTRAINT "FollowUpInspection_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "FollowUpInspection" ADD CONSTRAINT "FollowUpInspection_regionId_fkey" FOREIGN KEY ("regionId") REFERENCES "Region"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "FollowUpInspection" ADD CONSTRAINT "FollowUpInspection_districtId_fkey" FOREIGN KEY ("districtId") REFERENCES "District"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "FollowUpInspection" ADD CONSTRAINT "FollowUpInspection_communityId_fkey" FOREIGN KEY ("communityId") REFERENCES "Community"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "FollowUpInspection" ADD CONSTRAINT "FollowUpInspection_electoralAreaId_fkey" FOREIGN KEY ("electoralAreaId") REFERENCES "ElectoralArea"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
