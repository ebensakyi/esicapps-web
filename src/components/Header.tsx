                                    ...
                                    <span>Tables</span>
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <li>
                                                    <Link href="/submitted-data?formId=2&published=undefined&deleted=0&page=1&filterBy=&filterValue=&from&to=">
                                                        <i className="bi bi-circle" />
                                                        <span>Eatery</span>
                                                    </Link>
                                                </li> <li>
                                                    <Link href="/submitted-data?formId=3&published=undefined&deleted=0&page=1&filterBy=&filterValue=&from&to=">
                                                        <i className="bi bi-circle" />
                                                        <span>Health</span>
                                                    </Link>
                                                </li> <li>
                                                    <Link href="/submitted-data?formId=4&published=undefined&deleted=0&page=1&filterBy=&filterValue=&from&to=">
                                                        <i className="bi bi-circle" />
                                                        <span>Hospitality</span>
                                                    </Link>
                                                </li> <li>
                                                    <Link href="/submitted-data?formId=6&published=undefined&deleted=0&page=1&filterBy=&filterValue=&from&to=">
                                                        <i className="bi bi-circle" />
                                                        <span>Industry</span>
                                                    </Link>
                                                </li> <li>
                                                    <Link href="/submitted-data?formId=5&published=undefined&deleted=0&page=1&filterBy=&filterValue=&from&to=">
                                                        <i className="bi bi-circle" />
                                                        <span>Institution</span>
                                                    </Link>
                                                </li> <li>
                                                    <Link href="/submitted-data?formId=7&published=undefined&deleted=0&page=1&filterBy=&filterValue=&from&to=">
                                                        <i className="bi bi-circle" />
                                                        <span>Market</span>
                                                    </Link>
                                                </li> <li>
                                                    <Link href="/submitted-data?formId=8&published=undefined&deleted=0&page=1&filterBy=&filterValue=&from&to=">
                                                        <i className="bi bi-circle" />
                                                        <span>Sanitary</span>
                                                    </Link>
                                                </li>
                            ...
                            >
                                ...
                                <li>
                                    ...
                                    <li className="nav-item">
                                        ...
                                        >
                                            <li>
                                                <Link href="/submitted-data/follow-up?formId=1&deleted=0&page=1">
                                                    <i className="bi bi-circle" />
                                                    <span>Residential</span>
                                                </Link>
                                            </li>
                                            <li>
                                                <Link href="/submitted-data/follow-up?formId=2&deleted=0&page=1">
                                                    <i className="bi bi-circle" />
                                                    <span>Eatery</span>
                                                </Link>
                                            </li> <li>
                                                <Link href="/submitted-data/follow-up?formId=3&deleted=0&page=1">
                                                    <i className="bi bi-circle" />
                                                    <span>Health</span>
                                                </Link>
                                            </li> <li>
                                                <Link href="/submitted-data/follow-up?formId=4&deleted=0&page=1">
                                                    <i className="bi bi-circle" />
                                                    <span>Hospitality</span>
                                                </Link>
                                            </li> <li>
                                                <Link href="/submitted-data/follow-up?formId=5&deleted=0&page=1">
                                                    <i className="bi bi-circle" />
                                                    <span>Industry</span>
                                                </Link>
                                            </li> <li>
                                                <Link href="/submitted-data/follow-up?formId=6&deleted=0&page=1">
                                                    <i className="bi bi-circle" />
                                                    <span>Institution</span>
                                                </Link>
                                            </li> <li>
                                                <Link href="/submitted-data/follow-up?formId=7&deleted=0&page=1">
                                                    <i className="bi bi-circle" />
                                                    <span>Market</span>
                                                </Link>
                                            </li> <li>
                                                <Link href="/submitted-data/follow-up?formId=8&deleted=0&page=1">
                                                    <i className="bi bi-circle" />
                                                    <span>Sanitary</span>
                                                </Link>
                                            </li>
...
" />
                        ...
                        <li className="nav-item">
                            ...
                            > {session?.user?.privileges?.includes(11) ?
                                <li>
                                    <Link href="/primary-data/district?page=1&searchText=undefined">
                                        <i className="bi bi-circle" />
                                        <span>District</span>
                                    </Link>
                                </li> : <></>}
                                {session?.user?.privileges?.includes(12) ? <li>
                                    <Link href="/primary-data/electoral-area?page=1&searchText=undefined">
                                        <i className="bi bi-circle" />
                                        <span>Electoral Area</span>
                                    </Link>
                                </li> : <></>}
                                {session?.user?.privileges?.includes(13) ? <li>
                                    <Link href="/primary-data/community?page=1&searchText=undefined">
                                        <i className="bi bi-circle" />
                                        <span>Community</span>
                                    </Link>
                                </li> : <></>}
