...
export async function POST(request: Request) {
  try {
    ...
    const data = {
        ...
        facilityName: res.facilityName== "null"
        ? null:res.facilityName,
        ...
        numberSheds:
          res.numberSheds == "null" ? null : Number(res.numberSheds),
  
        numberStalls:
          res.numberStalls == "null" ? null : Number(res.numberStalls),
  
        numberTraders:
          res.numberTraders == "null"
            ? null
            : Number(res.numberTraders),
  
        numberMeatShops:
          res.numberMeatShops == "null"
            ? null
            : Number(res.numberMeatShops),
        numberColdStores:
          res.numberColdStores == "null"
            ? null
            : Number(res.numberColdStores),
        numberMills:
          res.numberMills == "null" ? null : Number(res.numberMills),
        numberChopbars:
          res.numberChopbars == "null"
            ? null
            : Number(res.numberChopbars),
        ...
        numberLorrySheds:
          res.numberLorrySheds == "null"
            ? null
            : Number(res.numberLorrySheds),
        numberVehicles:
          res.numberVehicles == "null"
            ? null
            : Number(res.numberVehicles),
        numberDrivers:
          res.numberDrivers == "null"
            ? null
            : Number(res.numberDrivers),
        numberFoodVendors:
          res.numberFoodVendors == "null"
            ? null
            : Number(res.numberFoodVendors),
      };
