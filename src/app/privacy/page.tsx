                            ...
                            <div className="card-body">
                                <div>
                                    ...
                                    <ul>
                                        ...
                                        <li>Usage Data: Information about how you interact with the app, including features used and time spent.</li>
                                        <li>Location Data: If you grant us permission, we may collect your precise or approximate location.</li>
                                    </ul>
                                    ...
                                    <ul>
                                        <li>Information you provide during account registration or app usage.</li>
                                        <li>Automatic data collection technologies like cookies and analytics tools.</li>
                                    </ul>
                                    ...
                                    <ul>
                                        ...
                                        <li>Analyzing app usage to enhance performance and features.</li>
                                    </ul>

                                    <p>We may share user data with:</p>
                                    <ul>
                                        <li>Service Providers: Third-party companies assisting in app operations.</li>
                                        <li>Legal Requirements: When required by law or to protect our rights.</li>
                                    </ul>

                                    <h2>4. Secure Data Handling Procedures</h2>

                                    <p>We implement reasonable security measures to protect user data, including:</p>
                                    <ul>
                                    ...
                                    <p>We reserve the right to update this Privacy Policy. Any changes will be posted on our website or within the app. Please review this policy periodically for updates.</p>

                                    <h2>8. Contact Us</h2>

                                    <p>If you have questions or concerns about this Privacy Policy, please contact us at esicapp2022@gmail.com.</p>

                                    <p>By using ESICApps, you consent to the terms outlined in this Privacy Policy.</p>

                                    <address>
                                        Ministry of Sanitation and Water Resources<br />
                                        Starlets 91 Rd, Accra<br />
                                        Accra, Ghana<br />
                                        <a href="http://mswr.gov.gh/">http://mswr.gov.gh/</a><br />
                                        Email: <a href="mailto:esicapp2022@gmail.com">App Email</a><br />
                                        Phone: 0543212322
                                    </address>
                                </div>
