...
const get = async (req, res) => {
  ...
  if (userType == 3 || userType == 4) {
    console.log("Here fileter ", filterBy);

    filterBy = filterBy == "undefined" ? "regionId" : filterBy;
    filterValue =
      filterValue == "undefined" ? userObj?.user?.regionId : filterValue;

      console.log("fvvv ",filterValue);
  }

  if (userType == 5 || userType == 6) {
    filterBy = filterBy == "undefined" ? "districtId" : filterBy;
    filterValue =
      filterValue == "undefined" ? userObj?.user?.districtId : filterValue;
  }

  console.log("filterBy1===>", filterBy);

  console.log("filterBy2===>", typeof filterBy);
