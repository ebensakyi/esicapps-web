          ...
          <div className="row row-cols-lg-auto g-3 align-items-center">
            {nationalUser ? (
              <>
                ...
                <div className="col-md-2" hidden={filterBy!="regionId"}>
                ...
                <div className="col-md-2" hidden={filterBy!="districtId"}>
            ...
            <div className="col-md-2" hidden={filterBy!="electoralAreaId"}>
            ...
            <div className="col-md-2" hidden={filterBy!="communityId"}>
