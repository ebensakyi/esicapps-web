...
//     );
//     setBathroomAvailability(
//       data?.ResidentialPremisesInfoSection?.bathroomAvailability?.id
//     );
//     setDrainAvailability(
//       data?.ResidentialPremisesInfoSection?.drainsAvailability?.id
//     );
//     setHandWashingAvailability(
//       data?.ResidentialPremisesInfoSection
//         ?.approvedHandwashingFacilityAvailability?.id
//     );
...
//       data?.ResidentialPremisesInfoSection?.animalAvailability?.id
//     );
//     setAnimalNumber(data?.ResidentialPremisesInfoSection?.animalNumber);
//     setVaccinationProof(
//       data?.ResidentialPremisesInfoSection?.vaccinationProof?.id
//     );
//     setAnimalSpaceCondition(
//       data?.ResidentialPremisesInfoSection?.animalSpaceCondition?.id
//     );
//   }, []);
//   return (
//     <>
