                            ...
                            <div className="col-md-9">
                                ...
                                >
                                    ...
                                    <div
                                        ...
                                        id="cemetery-workers"
                                        role="tabpanel"
                                        aria-labelledby="cemetery-workers-tab"
                                    ><div class="justify-content-between d-flex align-items-center mt-3 mb-4">
                                            <h5 class="mb-0 pb-1 text-decoration-underline">Cemetery worker</h5>
                                        </div>
                                        <div className="d-flex mb-2">
                                            <div className="card-body">
                                                {/* <p className="text-muted">
                                ...
                                <code>max-height: **px</code> to set default scrollbar.
                                    ...
                                    <div
                                        ...
                                        aria-labelledby="cemetery-workers-tab"
                                    ><div class="justify-content-between d-flex align-items-center mt-3 mb-4">
                                            <h5 class="mb-0 pb-1 text-decoration-underline">Community</h5>
                                        </div>
                                        <div className="d-flex mb-2">
                                            <div className="card-body">
