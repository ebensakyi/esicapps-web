      ...
      <div className="row">
        <div className="col-12">
          <div className="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 className="mb-sm-0">INSTITUTION</h4>
            <div className="page-title-right">
              <ol className="breadcrumb m-0">
                <li className="breadcrumb-item">
                  <a href="javascript: void(0);">Institution list</a>
                </li>
              ...
              <div className="card product">
                <div className="card-body">
                  <div className="row gy-3">
                    ...
                    {data?.InstitutionPremisesInfoSection?.bathroomAvailability !=
                    null ? (
                      <div className="col-lg-3 col-sm-6">
                        <label htmlFor="invoicenoInput">
                    ...
                    {data?.InstitutionPremisesInfoSection?.approvedHandwashingFacilityAvailabilityInstitution !=
                    null ? (
                      <div className="col-lg-3 col-sm-6">
                        <label htmlFor="invoicenoInput">
                        ...
                        <input
                          ...
                          id="invoicenoInput"
                          value={
                            data?.InstitutionPremisesInfoSection?.approvedHandwashingFacilityAvailabilityInstitution?.name
                          }
                          readOnly="readOnly"
                        />
                      </div>
                    ...
                    {data?.InstitutionPremisesInfoSection?.numberNonTeachingStaff !=
                    null ? (
                      <div className="col-lg-3 col-sm-6">
                        <label htmlFor="invoicenoInput">
                    ...
                    {data?.InstitutionPremisesInfoSection?.numberTeachingStaff !=
                    null ? (
                      <div className="col-lg-3 col-sm-6">
                        <label htmlFor="invoicenoInput">
                    ...
                    {data?.InstitutionPremisesInfoSection?.numberFemaleStudents !=
                    null ? (
                      <div className="col-lg-3 col-sm-6">
                        <label htmlFor="invoicenoInput">
                  ...
                  {data?.InstitutionPremisesInfoSection?.animalSpaceCondition !=
                  null ? (
                    <div className="col-lg-3 col-sm-6">
                      <label htmlFor="invoicenoInput">
              ...
              <div className="card product">
                <div className="card-body">
                  <div className="row gy-3">
                    ...
                    {data?.LicencePermitSection?.buildingPermitAvailability != null ? (
                      <div className="col-lg-3 col-sm-6">
                        ...
                        <input
                          ...
                          id="invoicenoInput"
                          value={
                            data?.LicencePermitSection?.buildingPermitAvailability?.name
                          }
                          readOnly="readOnly"
                        />
                      </div>
                    ...
                    {data?.LicencePermitSection?.habitationCertificateAvailability != null ? (
                      <div className="col-lg-3 col-sm-6">
                        ...
                        <input
                          ...
                          id="invoicenoInput"
                          value={
                            data?.LicencePermitSection?.habitationCertificateAvailability?.name
                          }
                          readOnly="readOnly"
                        />
                      </div>
                    ...
                    {data?.LicencePermitSection?.propertyRateAvailability != null ? (
                      <div className="col-lg-3 col-sm-6">
                        ...
                        <input
                          ...
                          id="invoicenoInput"
                          value={
                            data?.LicencePermitSection?.propertyRateAvailability?.name
                          }
                          readOnly="readOnly"
                        />
                      </div>
                    ...
                    {data?.LicencePermitSection?.suitabilityCertificateAvailability != null ? (
                      <div className="col-lg-3 col-sm-6">
                        <label htmlFor="invoicenoInput">
                        ...
                        <input
                          ...
                          id="invoicenoInput"
                          value={
                            data?.LicencePermitSection?.suitabilityCertificateAvailability?.name
                          }
                          readOnly="readOnly"
                        />
                      </div>
                    ...
                    null ? (
                      <div className="col-lg-3 col-sm-6">
                        ...
                        <input
                          ...
                          id="invoicenoInput"
                          value={
                            data?.LicencePermitSection?.structurePermitAvailability?.name
                          }
                          readOnly="readOnly"
                        />
                      </div>
                    ...
                    null ? (
                      <div className="col-lg-3 col-sm-6">
                        ...
                        <input
                          ...
                          id="invoicenoInput"
                          value={
                            data?.LicencePermitSection?.regGeneralCertAvailability?.name
                          }
                          readOnly="readOnly"
                        />
                      </div>
                    ...
                    null ? (
                      <div className="col-lg-3 col-sm-6">
                        ...
                        <input
                          ...
                          id="invoicenoInput"
                          value={
                            data?.LicencePermitSection?.medicalCertificateAvailability?.name
                          }
                          readOnly="readOnly"
                        />
                      </div>
                    ...
                    {data?.LicencePermitSection?.gtaOperatingLicenceAvailability != null ? (
                      <div className="col-lg-3 col-sm-6">
                        ...
                        <input
                          ...
                          id="invoicenoInput"
                          value={
                            data?.LicencePermitSection?.gtaOperatingLicenceAvailability?.name
                          }
                          readOnly="readOnly"
                        />
                      </div>
              ...
              <div className="card product">
                <div className="card-body">
                  <div className="row gy-3">
                    ...
                    0 ?  <div className="col-lg-3 col-sm-6">
                      <label htmlFor="invoicenoInput">
