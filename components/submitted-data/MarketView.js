...
const MarketView = ({ data }) => {
  ...
  const publish = async (id) => {
    try {
      const response = await axios.post(`/api/v1/submitted-data/market-view`, {
        id: id,
      });

      if (response.statusCode == 200) {
        router.push("/submitted-data/market?published=0");
      }
    } catch (error) {
      console.log(error);
    }
              ...
              <div className="card product">
                <div className="card-body">
                  <div className="row gy-3">
                    ...
                    null ? (
                      <div className="col-lg-3 col-sm-6">
                        ...
                        <input
                          ...
                          id="invoicenoInput"
                          value={
                            data?.MarketPremisesInfoSection?.toiletAvailability?.name
                          }
                          readOnly="readOnly"
                        />
                      </div>
                    ...
                    null ? (
                      <div className="col-lg-3 col-sm-6">
                        ...
                        <input
                          ...
                          id="invoicenoInput"
                          value={
                            data?.MarketPremisesInfoSection?.urinalAvailability?.name
                          }
                          readOnly="readOnly"
                        />
                      </div>
                    ...
                    null ? (
                      <div className="col-lg-3 col-sm-6">
                        ...
                        <input
                          ...
                          id="invoicenoInput"
                          value={
                            data?.MarketPremisesInfoSection?.bathroomAvailability?.name
                          }
                          readOnly="readOnly"
                        />
                      </div>
                    ...
                    null ? (
                      <div className="col-lg-3 col-sm-6">
                        ...
                        <input
                          ...
                          id="invoicenoInput"
                          value={
                            data?.MarketPremisesInfoSection?.drainsAvailability?.name
                          }
                          readOnly="readOnly"
                        />
                      </div>
                    ...
                    {data?.MarketPremisesInfoSection?.approvedHandwashingFacilityAvailabilityMarket !=
                    null ? (
                      <div className="col-lg-3 col-sm-6">
                        <label htmlFor="invoicenoInput">
                        ...
                        <input
                          ...
                          id="invoicenoInput"
                          value={
                            data?.MarketPremisesInfoSection?.approvedHandwashingFacilityAvailabilityMarket?.name
                          }
                          readOnly="readOnly"
                        />
                      </div>
