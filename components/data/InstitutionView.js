              ...
              <div className="card product">
                <div className="card-body">
                  <div className="row gy-3">
                    ...
                    {data.InstitutionPremisesInfoSection.householdNumber !=
                    null ? (
                      <div className="col-lg-3 col-sm-6">
                        <label htmlFor="invoicenoInput">
                          Number of household
                    ...
                    {data.InstitutionPremisesInfoSection.maleOccupantNumber !=
                    null ? (
                      <div className="col-lg-3 col-sm-6">
                        <label htmlFor="invoicenoInput">
                    ...
                    {data.InstitutionPremisesInfoSection.femaleOccupantNumber !=
                    null ? (
                      <div className="col-lg-3 col-sm-6">
                        <label htmlFor="invoicenoInput">
                    ...
                    {data.InstitutionPremisesInfoSection.animalAvailability !=
                    null ? (
                      <div className="col-lg-3 col-sm-6">
                        <label htmlFor="invoicenoInput">
                          Animal availabilty
                    ...
                    {data.InstitutionPremisesInfoSection.animalNumber !=
                    null ? (
                      <div className="col-lg-3 col-sm-6">
                    ...
                    {data.InstitutionPremisesInfoSection.PremisesAnimal
                      .length != 0 ? (
                      <div className="col-lg-3 col-sm-6">
                        <label htmlFor="invoicenoInput">Animals</label>
                        {data.InstitutionPremisesInfoSection.PremisesAnimal.map(
                          (x) => (
                            <input
                              key={x.id}
                              type="text"
                    ...
                    {data.InstitutionPremisesInfoSection.vaccinationProof !=
                    null ? (
                      <div className="col-lg-3 col-sm-6">
                        <label htmlFor="invoicenoInput">
